GO
/****** Object:  StoredProcedure [dbo].[pr_get_lista_recibos_bycliente]    Script Date: 07/28/2008 10:48:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[pr_get_lista_recibos_bycliente](@id_cliente int)
